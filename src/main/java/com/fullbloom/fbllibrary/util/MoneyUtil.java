...
public class MoneyUtil {
	...
	public static String getMoneyText(double money){
		...
		BigDecimal value = b.setScale(2,   BigDecimal.ROUND_HALF_UP);
	 ...
	 * @return
	 */
	public static String getCoinText(double coin){
		BigDecimal b   =   new BigDecimal(coin);
		double value = b.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();
		boolean isInt = 100*(int)value-100*value>=0?true:false;
		if(isInt){
